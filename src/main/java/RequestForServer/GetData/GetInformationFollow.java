...
public class GetInformationFollow {
        //  lay thong tin nhu ten truyen, tong so chapter va avatar truyen cua tat ca truyen dang theo doi
        public static ArrayList<SV_ComicsInformation> getAllComicsFollowInformation(int idUser) {
            ...
            CL_Request req = new CL_Request("/get/AllComicsFollow");
            ...
            try {
                ...
                if(dataConvertFromServer != null) {
                    ...
                    System.out.println("/get/AllComicsFollow is null");
                }
