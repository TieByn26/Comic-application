...
public class RequestAddComic {
    public static String addNewComic(SV_ComicsInformation sv_comicsInformation, SV_Chapter sv_chapter, SV_CategoryManager sv_categoryManager, SV_CategoryComics sv_categoryComics) {
        Gson gson = new Gson();
        ...
        try (BufferedWriter fromClient = new BufferedWriter(new OutputStreamWriter(socket.getOutputStream()));
            ...
            CL_Request request = new CL_Request("add/new/comic");
            ...
            //gui du lieu lan 4
            String jsonCateComic = gson.toJson(sv_categoryComics);
            fromClient.write(jsonCateComic);
            fromClient.newLine();
            fromClient.flush();
