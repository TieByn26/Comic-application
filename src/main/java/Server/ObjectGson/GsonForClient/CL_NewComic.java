...
public class CL_NewComic {
    ...
    public CL_NewComic(String nameComic, String idComic, String author, String status, String description, String avatarComic, int numberOfChapter) {
